...
class IndexBE extends IndexBase
{
    ...
    function __construct()
    {
        ...
        $menu = [
            HomeBE::class => 'Home',
            ServerStat::class => new Recursive('Info', [
                ServerStat::class => 'Server Stat',
                ServerData::class => 'Server Data',
                Session::class => 'Session',
                Cookies::class => 'Cookies',
                ConfigView::class => 'config.yaml',
                PHPInfo::class => 'phpinfo()',
                AboutNadlib::class => 'About',
                Documentation::class => 'Documentation',
                IniCheck::class => 'php.ini Check',
                TimeTrackHG::class => 'Time Track',
                Issues::class => 'Issues',
            ]),
            UnitTestReport::class => new Recursive('Test', [
                UnitTestReport::class => 'Unit Test Report',
                ValidatorCheck::class => 'Validator Check',
                TestQueue::class => 'Test Queue',
            ]),
            ExplainQuery::class => new Recursive('DB', [
                AlterDB::class => 'Alter DB',
                AlterCharset::class => 'Alter Charset',
                AlterTable::class => 'Alter Table',
                AlterIndex::class => 'Alter Indexes',
                OptimizeDB::class => 'Optimize DB',
                ExplainQuery::class => 'Explain Query',
                Localize::class => 'Localize',
            ]),
            ClearCache::class => new Recursive('FE', [
                ClearCache::class => 'Clear Cache',
                JumpFrontend::class => '<- Frontend',
            ]),
        ];
